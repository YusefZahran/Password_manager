...
class CustomSearchBar:
    ...
    def __init__(self, master: tk.Misc, text_variable: tk.Variable = None, command=None, search_button_text="Search",
        ...
        :param command: The command to execute when the search button is clicked.
        ...
        CustomEntry(master, text_variable=text_variable, x=x, y=y)

        CustomButton(master, text=search_button_text, button_size=globals.SMALL_BUTTON_SIZE, command=command,
                     x=x_offset, y=y)
